...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor>{
    ...
    public void attemptLogin() {
        ...
        if (cancel) {
            ...
            Log.v(TAG, "Trying to login with " + email + " and " + password);
    ...
    private void gotoLogged(String session) {
        Intent intent = new Intent("pl.warsjawa.android.lab1.SHOW_LOGGED");
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            return mLabService.login(mEmail, mPassword);
        }
        ...
        protected void onPostExecute(final String session) {
            ...
            if (!TextUtils.isEmpty(session)) {
                SharedPreferences.Editor prefs = LoginActivity.this.getPreferences(MODE_PRIVATE).edit();
                prefs.putString("login", mEmail);
